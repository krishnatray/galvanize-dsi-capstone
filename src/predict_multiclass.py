...
if __name__ == "__main__":
    ...
    tfifd = "model/tfidf_multiclass.pkl"
    saved_model =  "model/multiclass.pkl"
    le_saved_file = "model/le_multiclass.pkl"
    ...
    le_saved = joblib.load(le_saved_file)

    print(le_saved.inverse_transform(mymodel.predict(X_tfidf[:100])))
